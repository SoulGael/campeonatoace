...
function diciplinaGuardar($diciplina, $hora) {

	$resultado = "";
	if($resultado = pg_query("insert into tbl_diciplina (diciplina, hora) values (UPPER('".$diciplina."'), '".$hora."' )") or die (pg_last_error())){
		return true;
	}
...
function diciplinaModificar($id, $diciplina, $estado, $hora) {

	$resultado = "";
	if($resultado = pg_query("update tbl_diciplina set diciplina='".$diciplina."', hora='".$hora."', estado=".$estado." where id_diciplina=".$id." ") or die (pg_last_error())){
		return true;
	}
